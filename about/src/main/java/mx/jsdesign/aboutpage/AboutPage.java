 ...
 * <p>
 * To create a custom item in the about page, pass an instance of {@link mx.jsdesign.aboutpage.Element}
        ...
        if (element.getIconDrawable() != null) {
            ...
            if (element.getAutoApplyIconTint()) {
                ...
                if (currentNightMode != Configuration.UI_MODE_NIGHT_YES) {
                    ...
                    //DrawableCompat.setTint(wrappedDrawable, ContextCompat.getColor(mContext, android.R.color.white));
